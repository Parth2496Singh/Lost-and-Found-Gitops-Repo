...
deploy_project(){
    ...
    mkdir -p /home/ubuntu/Lost-Found-Project
    cd /home/ubuntu/Lost-Found-Project

    # 1. Download the docker-compose.yml
    curl -L -o docker-compose.yml https://raw.githubusercontent.com/Parth2496Singh/Lost-and-Found-Gitops-Repo/refs/heads/main/docker-compose.yml
